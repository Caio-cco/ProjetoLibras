...
const VIDEO_DEMONSTRATIVO_URL = 'https://www.youtube.com/watch?v=EK6zOYT_ckk';
const UPLOAD_URL = 'SUA_URL_DE_UPLOAD_AQUI'; 
...
export default function ImiteOSinal() {
    ...
    async function enviarVideo() {
        if (!videoGravadoBlob) {
            console.error("Nenhum vídeo gravado para enviar.");
            return;
        }
