...
//           <h1>Palavras em Libras</h1>
//           <p>Associe a imagem com a palavra</p>
//         </div>
//       </div>
...
export default function AssosiacaoBasico() {
  ...
  return (
    <div className="associacao-basico">
      ...
      <div className="banner-conteudo">
        <img src="/maolaranja.png" alt="Mão laranja" className="banner-imagem" />
        <div className="banner-texto">
          <h1>Palavras em Libras</h1>
          <p>Associe o sinal com sua palavra correspondente</p>
        </div>
      </div>
      ...
      {exibirConteudo && (
        <main className="conteudo" aria-busy={!!modalData}>
          <div className="card">
            <h2>Clique em um sinal e depois em sua palavra correspondente</h2>
      ...
      {!exibirConteudo && totalEtapas === 0 && (
        <main className="conteudo">
          <div className="card">
            <h2>{todosParesCarregados.length === 0 ? "Nenhuma atividade de Associação de Palavras encontrada." : "Carregando..."}</h2>
